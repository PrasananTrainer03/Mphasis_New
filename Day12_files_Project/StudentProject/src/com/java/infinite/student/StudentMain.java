...
public class StudentMain {
	...
	public static void readStudentFile() throws ClassNotFoundException, IOException {
		System.out.println(new StudentBAL().readStudentBal());
	}
	
	public static void writeStudentFile() throws ClassNotFoundException, IOException {
		System.out.println(new StudentBAL().writeStudentBal());
	}
