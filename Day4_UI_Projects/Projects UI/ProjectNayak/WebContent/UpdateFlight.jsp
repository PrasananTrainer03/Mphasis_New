...
<body>
	...
	<%
	  String flightIdUp=(String)session.getAttribute("FlightIdUp");
	...
	<table width="100%">
		...
		<tr id="img2">
			<th><div class="topnav">
				...
				<form method="post" action="FlightUpdationServlet">
					<div class="abc">
						<div>
							<table border='0' width='480px' cellpadding='0' cellspacing='0'
								...
								<center>
									<tr>
										<td align='center' colspan="2"><h1>Update a Flight</h1></td>
									</tr>
								</center>
								...
								<tr>
									...
									<td><input type='text' name='id' value="<%= flightIdUp %>" readonly="readonly"></td>
								</tr>
								<tr>
									<td>&nbsp;</td>
								</tr>
								...
								<tr>
									<td align='center'>Departure Time:<font
										style="color: red;">*</font></td>
								...
								<table border='0' cellpadding='0' cellspacing='0' width='480px'
									align='center'>
									<tr>
										<td align='center'><button id="button" type="submit"
