				...
				<div class="abc" style="margin-left: 100px; margin-right: 650px;">
								...
								<div>
									...
									<tr>
										...
										<td><font color="black" size="5px">&nbsp;&nbsp;&nbsp;&nbsp;Rs.
												<%=session.getAttribute("total")%></font></td>
									</tr>
									...
									<tr>
										<td><font color="black" size="4px">Credit Card
												Number: </font></td>
										<td>&nbsp;&nbsp;&nbsp;&nbsp;<input type="text"
											name="credit"
											placeholder="Enter 16 digits credit card number"
											style="height: 5px; width: 200px; padding: 12px 20px; margin-bottom: 10px; margin-top: 15px;" /><br>
											<br>
					...
					<!-- <form action="CancelAction.jsp">
						<input type="submit" value="Cancel"
											style="background-color: red;font-weight:bold; ;color: white; padding: 10px 10px; margin: 4px 0; border: none; cursor: pointer; width: 20%;" />
					</form> -->
				</div>
				</th>
				</tr>
